...
const translations = {
    en: {
        ...
        'point.b': 'Point B (End)',
        'height.label': 'Antenna Height (m AGL)',
        ...
        'mobile.antenna-a': 'ANTENNA A (m AGL)',
        'mobile.antenna-b': 'ANTENNA B (m AGL)',
    ...
    pl: {
        ...
        'height.label': 'Wysoko\u015b\u0107 Anteny (m AGL)',
        ...
        'mobile.antenna-a': 'ANTENA A (m AGL)',
        'mobile.antenna-b': 'ANTENA B (m AGL)',
